...
class _HomePageState extends State<HomePage> {
  ...
  double calculateAveragePoint(List<Data> dataList) {
    int totalPoints = 0;
    for (var data in dataList) {
      totalPoints = totalPoints + data.value.toInt();
    }
    return totalPoints / dataList.length;
  }
    ...
    switch (_period) {
      case 'week':
        ...
        for (var jsonMap in decodedReportsResponse) {
          data.add(Data(
            DateTime.parse(jsonMap['createDate'].toString()),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          calculateAveragePoint(snapshot.data!).toStringAsFixed(1),
                    ...
                    child: SfCartesianChart(
                      ...
                      primaryXAxis: DateTimeAxis(
                        ...
                        plotBands: <PlotBand>[
                          PlotBand(
                            isVisible: true,
                            start: snapshot.data![0].date,
                            end: snapshot.data![0].date,
                            color: Colors.blue,
                          )
                        ],
                        majorGridLines:
